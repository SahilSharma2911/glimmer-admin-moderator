...
> = {
  ...
  RESOLVED: { pill: "bg-slate-100 text-slate-500", dot: "bg-slate-400" },
  MARK_SAFE: { pill: "bg-emerald-50 text-emerald-600", dot: "bg-emerald-500" },
  REMOVE_CONTENT: { pill: "bg-rose-50 text-rose-600", dot: "bg-rose-500" },
};
